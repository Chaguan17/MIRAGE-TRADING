...
def load_trading_history():
    """Carga el historial de trades cerrados desde SQLite para usarlos como dataset de optimización."""
...
def run_optimization():
    ...
    print("Extrayendo histórico de características reales y resultados de rentabilidad...")
    from data_engine import DataEngine
    feat_cols = DataEngine().get_feature_columns()
